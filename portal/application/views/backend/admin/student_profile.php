...
<div class="profile-env">
    ...
    <div class="col-md-9">
      ...
      <li class="">
        ...
        <?php
          $basic_info_titles = ['name', 'class', 'section',  'gender', 'birthday'];
          $basic_info_values = [$row['name'], 
        ...
        <table class="table table-bordered" style="margin-top: 20px;">
          ...
          <?php } ?>
           <?php $parents= $this->db->get_where('parent_assignment', array('student_id' => $row['student_id']))->result(); 
              
                 foreach ($parents as $parent) {
                    $parent_name = $this->db->get_where('parent', array('parent_id' => $parent->parent_id))->row()->name; ?>
                  <tr>
                <td>Parent name </td><td><?php echo $parent_name ?></td> 
                </tr>   
               <?php  }  ?>
          </tbody>
        </table>
        ...
        <?php } else {
          ...
          foreach ($parents as $parent) {
            $parent_info = $this->db->get_where('parent', array('parent_id' => $parent->parent_id))->result_array();
