    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'goals_manage' || $page_name == 'goals_manage_view') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/goals_manage">
                        <span><i class="entypo-dot"></i> Manage Goals</span>
                    </a>
                </li>
