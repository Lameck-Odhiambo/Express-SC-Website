...
<div class="row">
	...
	<div class="col-md-2">
		...
		<label class="control-label" style="margin-bottom: 5px;">Fixture Name:</label>
			<input name ="fixture" type="text" class="form-control lg" placeholder="fixture"/>
		</div>
	</div>
	...
	<div id="subject_holder">
		...
		<div class="col-md-2" style="margin-top: 20px;">
			<center>
				<button type="submit" class="btn btn-info" id = "submit">Manage Match Perfomance</button>
			</center>
		</div>
	</div>
