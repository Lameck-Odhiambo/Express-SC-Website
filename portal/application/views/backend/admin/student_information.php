                ...
                <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
                            ...
                            <th class="span3"><div><?php echo get_phrase('sex');?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <b>-- (<?php echo date_diff(date_create($this->db->get_where('student' , array('student_id' => $row['student_id']
                                    ))->row()->birthday), date_create('today'))->y; ?> Yrs)</b>
                            </td>
                            <td>
