...
class Crud_model extends CI_Model {
    ...
    function send_new_private_message() {
        ...
        $contacts = $this->db->get_where('parent', array('parent_id'=>$reciever))->row();
        ...
        $notify ="You got a new message. Login to soccer academy and read your message";
        $sub = "Express Soccer Academy New Message Notification";
        $this->email_model->do_email($notify, $sub, $email);
        $this->sms_model->send_msg_via_africaStalking('You got a new message. Login to soccer academy and read your message', $number);
