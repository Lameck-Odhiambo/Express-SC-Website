...
class Email_model extends CI_Model {
	...
	function account_opening_email($account_type = '' , $email = '', $password = '')
	{
		...
		$email_msg		.=	"Your login credentials : ". $password ."<br />";
...
/*		$config = array();
        ...
        $config['smtp_host']	= "mail.expresssocceracademy.com";
		...
		$msg	=	$msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"http://algominetech.com\">&copy; 2018 Algominetech</a></center>";
		$this->email->message($msg);

		$this->email->send();*/
                                    $ToEmail = $to;
								    $EmailSubject =  $sub;
								    $mailheader = "From: info@expresssocceracademy.com";
								    $mailheader .= "Reply-To: info@expresssocceracademy.com\r\n";
								    $mailheader .= "Content-type: text/html; charset=iso-8859-1\r\n";
								    $MESSAGE_BODY ="<p style='font-weight:bold'>Hello, </p>";
								    $MESSAGE_BODY .="<p> A new message has been received </p>";
								    $MESSAGE_BODY .= $msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"http://algominetech.com\">&copy; 2018 Algominetech</a></center>";
